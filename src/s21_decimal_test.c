...
// s21_decimal x = {{150000008, 0, 500000000,
// 0b00000000000000000000000000000000}}; s21_decimal y = {{1, 0, 0,
// 0b00000000000000000000000000000000}}; s21_decimal z = {{0, 0, 0,
// 0b00000000000000000000000000000000}}; s21_setScale(&x, 0); s21_setScale(&y,
// 3); int n1 = 0; n1 = s21_mod(x, y, &z); char res1[1000], res2[1000] = "0 0 0
// 196608"; snprintf(res1, sizeof(char)*1000, "%u %u %u %u", z.bits[0],
// z.bits[1], z.bits[2], z.bits[3]); ck_assert_str_eq(res1, res2);
// ck_assert_int_eq(n1, 0);
// }
// END_TEST
